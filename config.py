...
class CameraConfig:
    ...
    DEFAULT_CAMERA_FPS = 60         # 默认相机帧率
    CAMERA_RECONNECT_DELAY = 1.0    # 相机重连延迟（秒）
    
    # 图像压缩
    JPEG_QUALITY = 100               # JPEG图像质量（1-100），用于进程间传输图像

class DisplayConfig:
    """显示配置"""
    
    # 文本显示
    INFO_TEXT_POSITION = (1, 10)   # 信息文本位置
    INFO_TEXT_SCALE = 0.3           # 信息文本大小
    INFO_TEXT_COLOR = (255, 255, 255)   # 信息文本颜色 (BGR)
    INFO_TEXT_THICKNESS = 1         # 信息文本粗细
    INFO_BACKGROUND_COLOR = (0, 0, 0, 0.3)  # 信息文本背景颜色 (BGR + 透明度)
    INFO_BACKGROUND_PADDING = (10, 5)  # 信息文本背景填充大小
